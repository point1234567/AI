...
function sendMessage() {
    ...
    // if message = developer - show our message
        ...
        setTimeout(() => {
            ...
            appendMessage('bot', 'This Source Coded By Limath Afthi');
    ...
    const options = {
        ...
        headers: {
            ...
            'X-RapidAPI-Key': 'sk-proj-hZ20YjZHOGsQfESyZMKTT3BlbkFJOe7snq4OF7OlBH4u49QX',
            'X-RapidAPI-Host': 'https://openai80.p.rapidapi.com/chat/completions'
